...
class SomaImpares {
    public static void main(String[] args) {
        ...
        int somaImpares = 0;//Declara a soma dos valores
        ...
        if ( quantidadeElementos > 0 ) {
           ...
           for (int contaInputs = 0 ; contaInputs < quantidadeElementos ; contaInputs++) {
               ...
               if (vetorSoma[contaInputs] %2 =! 0) {
			            somaImpares = somaImpares + vetorSoma[contaInputs];//Soma apenas os elementos pares do vetor (resultado da divisão por 2 =! 0)

              }
           }

           System.out.println( " " );
           System.out.println( "A soma dos números ímpares contidos no vetor é: " + somaImpares);
